;;; bespoke-dark-theme.el --- A minimal and medium contrast dark theme
...
;;;; Window Divs
   ...
   `(window-divider             ((,class :foreground ,bespoke-dark)))
   `(window-divider-first-pixel ((,class :foreground ,bespoke-dark)))
...
;;;; Dired (plus)
   ...
   `(diredp-file-name                            ((,class :foreground ,bespoke-light)))
...
;;;; Dired Colors (Diredfl)
   ...
   `(diredfl-tagged-autofile-name                 ((,class :foreground ,bespoke-dark)))
   ...
   `(diredfl-file-name                            ((,class :foreground ,bespoke-light)))
   ...
   `(diredfl-dir-heading                          ((,class :inherit    variable-pitch :foreground ,bespoke-blue :background ,bespoke-subtle)))
   ...
   `(diredfl-compressed-file-name                 ((,class :foreground ,bespoke-dark)))
